        ...
        <v-card elevation="24" rounded="xl" class="register-card pa-8">
          ...
          <v-form ref="registerForm" v-model="valid">
            ...
            <div v-show="step === 2" class="step-content">
              ...
              <v-text-field v-model="form.username" label="Nombre de usuario" prepend-inner-icon="mdi-at"
                variant="outlined" rounded="xl" placeholder="usuario123" :rules="usernameRules" color="#195030"
                class="mb-2">
                <template #append-inner>
...
.register-container {
  ...
  padding-top: 88px;
  /* 72px del header + 16px de espacio */
  padding-bottom: 80px;
